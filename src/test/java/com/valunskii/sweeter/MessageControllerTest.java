package com.valunskii.sweeter;

import com.valunskii.sweeter.controller.MessageController;
...
public class MessageControllerTest {
    ...
    public void messageListTest() throws Exception {
        this.mockMvc.perform(get("/main"))
                .andDo(print())
                .andExpect(authenticated())
                .andExpect(xpath("//div[@id='message-list']/div").nodeCount(4)); //because of 4 messages in message-list-before.sql
    }
    ...
    public void addMessageToListTest() throws Exception {
        ...
        this.mockMvc.perform(multipart)
                ...
                .andExpect(xpath("//div[@id='message-list']/div[@data-id=10]").exists()) //id=10 because of message-list-before.sql:line10
